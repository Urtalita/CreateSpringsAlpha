package net.Portality.createsprings.Items.SpringStufs.PortativeSteamEngine;
...
public class PortativeSteamEngineItem extends BaseArmorItem implements MenuProvider, ISpringPoweredTool {
    ...
    public void onArmor(ItemStack stack, Level level, Player player) {
        ...
        handleDash(boosted, player, level, tag);
    ...
    public void handleDash(int boosted, Player player, Level level, CompoundTag tag){
        if(boosted > 110){
