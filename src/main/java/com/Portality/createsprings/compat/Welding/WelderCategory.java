...
import com.Portality.createsprings.compat.CSpringsRecipeCategory;
...
public class WelderCategory extends CSpringsRecipeCategory<WelderRecipe> {
    ...
    public void draw(WelderRecipe recipe, IRecipeSlotsView view, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        Component speedText = Component.translatable(
                ...
                Component.translatable("createsprings.speed." + recipe.getSpeed().name().toLowerCase())
        );
