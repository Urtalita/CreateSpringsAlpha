...
public class CatapultItem extends BlockItem {
    public CatapultItem(Block p_i48527_1_, Item.Properties p_i48527_2_) {
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos pos, Level world, Player player, ItemStack p_195943_4_,
        ...
        if (!world.isClientSide && player instanceof ServerPlayer sp)
            CSpringsPackets.getChannel()
                    .send(PacketDistributor.PLAYER.with(() -> sp), new CatapultPlacementPacket.ClientBoundRequest(pos));
