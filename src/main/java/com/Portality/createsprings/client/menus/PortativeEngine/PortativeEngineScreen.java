...
public class PortativeEngineScreen extends AbstractSimiContainerScreen<PortativeSteamEngineMenu> {
    ...
    protected void init() {
        ...
        selector = new AnalogLeverSelector(x + 38, y + 68, 90, 6,
                (float) PortativeSteamEngineItem.getTargetSpeed(stack) / 15, false);
        ...
        boosted = PortativeSteamEngineItem.getOverdriveProgress(stack);
        if(PortativeSteamEngineItem.getOverdrive(stack)) {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        renderFluid(graphics, PortativeSteamEngineItem.getWater(stack) / 1000f, sx, sy);
